...
- (void)dealloc {
    ...
    [extraFooterText release], extraFooterText = nil;
...
- (void)textFieldDidBeginEditing:(UITextField *)textField {
	...
	if ([_tableView indexPathsForVisibleRows].count) {
		_topmostRowBeforeKeyboardWasShown = [(NSIndexPath*)[[_tableView indexPathsForVisibleRows] objectAtIndex:0] copy];
	} else {
